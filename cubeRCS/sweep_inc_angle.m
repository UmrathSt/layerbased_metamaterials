...
angles = [0,pi/4];#linspace(0, pi/4, 91);%linspace(0, pi/8, 46); % steps of 1 degree
freq = 30e9; % frequencies for which to obtain the RCS
Path = '/mnt/hgfs/E/openEMS/PVC_RCS_1-30/';
L = 50; % mm
