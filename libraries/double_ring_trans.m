function double_ring_trans(UCDim, fr4_thickness, R1, w1, R2, w2, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 0;
  UC.layer_fd = 0;
  UC.td_dumps = 1;
  ...
  UC.s11_subfolder = 'double_ring_trans';
  UC.run_simulation = 1;
  UC.show_geometry = 1;
  UC.grounded = 0;
  UC.unit = 1e-3;
  ...
  dblring1.complemential = 0;
  
  
  dblring2.name = 'double slits';
  dblring2.lz = 0.1;
  dblring2.rotate = 0;
  dblring2.material.name = 'copper';
  dblring2.material.Kappa = 56e6;
  dblring2.material.type = 'const';
  dblring2.bmaterial.name = 'air';
  dblring2.bmaterial.type = 'const';
  dblring2.bmaterial.Epsilon = 1;
  dblring2.R1 = 0;
  dblring2.R2 = R2;
  dblring2.w1 = 0;
  dblring2.w2 = w2;
  ...
  dblring2.complemential = 0;
  
  layer_list = {@CreateUC, UC; @CreateDoubleRing, dblring1;
