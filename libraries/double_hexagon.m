function double_hexagon(UCly, fr4_thickness, Cu_thickness, L1, w1, L2, w2, L3, w3, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 1;
  UC.layer_fd = 1;
  UC.td_dumps = 0;
  ...
  UC.dy = UC.dx;
  UC.dump_frequencies = linspace(7, 13, 25)*1e9;%, 5.2e9, 7.5e9];
  UC.s11_delta_f = 10e6;
  UC.EndCriteria = 1e-3;
