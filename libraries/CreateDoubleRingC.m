function [CSX, params] = CreateDoubleRingC(CSX, object, translate, rotate);
  object = object;
  ...
  CSX = AddCylindricalShell(CSX, ringmaterial, object.prio+1, 
        ...
        'Transform', {'Rotate_Z', rotate, 'Translate', translate});
  CSX = AddCylindricalShell(CSX, ringmaterial, object.prio+1, 
        ring_start, ring_stop, Rc-Wc/2, Wc,
        'Transform', {'Rotate_Z', rotate, 'Translate', translate});
  ...
  params = ["# circular rings made of "  ringmaterial " at center position x = " num2str(ocenter(1)) " y = " num2str(ocenter(2)) " z = " num2str(ocenter(3)) "\n" \
            ...
            "# capacitively coupled by ring of R, w = " num2str(Rc) ", " num2str(Wc) ", background material " bmaterial "\n"];
  return;
endfunction