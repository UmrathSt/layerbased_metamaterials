function [CSX, params] = CreateQuadRing(CSX, object, translate, rotate);
  object = object;
  ...
  params = ["# circular rings made of "  ringmaterial " at center position x = " num2str(ocenter(1)) " y = " num2str(ocenter(2)) " z = " num2str(ocenter(3)) "\n" \
            "# radius R1, R2, R3, R4=" num2str(R1) ", " num2str(R2) ", " num2str(R3) ", " num2str(R4) " ringwidths w1, w2, w3, w4 =" num2str(w1) ", " num2str(w2) ", " num2str(w3) ", " num2str(w4) ", background material " bmaterial "\n"];
  return;
endfunction