function rect(UCDim, fr4_thickness, L, slitN, slitL, slitW, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 0;
  UC.layer_fd = 1;
  UC.td_dumps = 0;
  ...
  UC.s11_filename_prefix = ['UCDim_' num2str(UCDim) '_lz_' num2str(fr4_thickness) '_L_' num2str(L) '_eps_' num2str(eps_subs) '_tand_' num2str(tand) '_slitN_' num2str(slitN) '_slitL_' num2str(slitL) '_slitW_' num2str(slitW)];
