function rectangular_patch(UCDim, rect_gap, fr4_thickness);
physical_constants;
UC.layer_td = 1;
UC.layer_fd = 0;
UC.td_dumps = 1;
...
UC.s11_delta_f = 10e6;
UC.EndCriteria = 1e-3;
UC.SimPath = ["/mnt/hgfs/E/openEMS/layerbased_metamaterials/rect_patches/" UC.s11_filename_prefix];
