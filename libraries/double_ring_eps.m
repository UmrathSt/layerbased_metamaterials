function double_ring_eps(UCDim, fr4_thickness, R1, w1, R2, w2, eps_FR4, tand, complemential);
  physical_constants;
  UC.layer_td = 1;
  UC.layer_fd = 0;
  UC.td_dumps = 1;
  ...
  UC.s11_filename_prefix = ['UCDim_' num2str(UCDim) '_lz_' num2str(fr4_thickness) '_R1_' num2str(R1) '_w1_' num2str(w1) '_R2_' num2str(R2) '_w2_' num2str(w2) '_epsFR4_' num2str(eps_FR4) '_tand_' num2str(tand)];
