...
function [x, obj, info, iter, nf, lambda] = my_sqp (x0, objf, cef, cif, lb, ub, maxiter, tolerance)
  global my_eps;
...
%!
%! assert (x, x_opt, 8*sqrt (my_eps));
%! assert (obj, obj_opt, sqrt (my_eps));
