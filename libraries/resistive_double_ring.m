function resistive_double_ring(UCDim, fr4_thickness, R1, w1, R2, w2, Resistance, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 0;
  UC.layer_fd = 0;
  UC.td_dumps = 0;
  ...
  UC.s11_filename_prefix = ['UCDim_' num2str(UCDim) '_lz_' num2str(fr4_thickness) '_R1_' num2str(R1) '_w1_' num2str(w1) '_R2_' num2str(R2) '_w2_' num2str(w2) '_Resistance_' num2str(Resistance) '_eps_' num2str(eps_subs) '_tand_' num2str(tand)];
  if complemential;
  ...
  dblring1.resistor.name = 'Chipresistor';
  dblring1.resistor.Kappa = 1/(Resistance*dblring1.lz*1e-3);
  dblring1.resistor.type = 'const';
  ...
  material_list = {substrate.material, rectangle.material, dblring1.material, dblring1.bmaterial, dblring1.resistor};
