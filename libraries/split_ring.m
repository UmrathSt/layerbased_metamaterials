function split_ring(UCDim, fr4_thickness, R, w, phi0, DeltaPhi, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 0;
  UC.layer_fd = 0;
  UC.td_dumps = 0;
  ...
  UC.s11_filename_prefix = ['UCDim_' num2str(UCDim) '_lz_' num2str(fr4_thickness) '_R_' num2str(R) '_w_' num2str(w) '_phi0_' num2str(phi0) '_DeltaPhi_' num2str(DeltaPhi) '_eps_' num2str(eps_subs) '_tand_' num2str(tand)];
  if complemential;
  ...
  material_list = {substrate.material, rectangle.material, splitring.material, splitring.bmaterial};
