function broadband_chipres(UCDim, fr4_thickness, R, w, L, a, Res, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 0;
  UC.layer_fd = 1;
  UC.td_dumps = 0;
  ...
  UC.s11_subfolder = 'broadband_chipres';
  UC.run_simulation = 1;
  UC.show_geometry = 0;
  UC.grounded = 1;
  UC.unit = 1e-3;
  ...
  layer_list = {@CreateUC, UC; @CreateRect, rectangle;
                               ...
                               @CreateBroadbandChipres, chipres;
                                 };
