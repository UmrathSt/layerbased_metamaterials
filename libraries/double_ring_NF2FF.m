function double_ring_NF2FF(UCDim, fr4_thickness, R1, w1, R2, w2, complemential);
  physical_constants;
  UC.layer_td = 1;
  UC.layer_fd = 1;
  UC.td_dumps = 1;
  ...
  UC.s11_filename_prefix = ["UCDim_" num2str(UCDim) "_lz_" num2str(fr4_thickness) "_R1_" num2str(R1) "_w1_" num2str(w1) "_R2_" num2str(R2) "_w2_" num2str(w2) "_18_microns"];
  complemential = complemential;
  if complemential;
    UC.s11_filename_prefix = horzcat(UC.s11_filename_prefix, "_comp");
  endif;
  UC.s11_filename = "Sparameters_";
  UC.s11_subfolder = "double_ring_NF2FF";
  UC.run_simulation = 1;
  UC.show_geometry = 0;
  UC.grounded = 1;
  UC.nf2ff = 1;
  ...
  UC.dx = UC.dz/2;
  UC.dy = UC.dz/2;
  UC.dump_frequencies = [2.4e9, 5.2e9, 10e9, 15e9];
  UC.s11_delta_f = 10e6;
  UC.EndCriteria = 5e-4;
  ...
  rectangle.material.type = "constant";
  rectangle.material.EpsilonRelaxTime = 1.59e-9/(2*pi);
  rectangle.material.EpsilonPlasmaFrequency = 2e14/(2*pi);
  ...
  substrate.material.type = "constant";
  ...
  dblring.material.type = "constant";
  dblring.material.EpsilonRelaxTime = 1.59e-9/(2*pi);
  dblring.material.EpsilonPlasmaFrequency = 2e14/(2*pi);
  dblring.bmaterial.name = "air";
  dblring.bmaterial.type = "constant";
  ...
  material_list = {rectangle.material, substrate.material, dblring.material, dblring.bmaterial};
