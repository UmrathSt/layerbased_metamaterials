function double_ringCB(UCDim, fr4_thickness, R1, w1, R2, w2, R3, w3, R4, w4, eps_subs, tand, mesh_refinement, complemential);
  physical_constants;
  UC.layer_td = 1;
  UC.layer_fd = 1;
  UC.td_dumps = 1;
  ...
  UC.s11_filename_prefix = ["UCDim_" num2str(UCDim) "_lz_" num2str(fr4_thickness) "_R1_" num2str(R1) "_w1_" num2str(w1) "_R2_" num2str(R2) "_w2_" num2str(w2) "_R3_" num2str(R3) "_w3_" num2str(w3) "_R4_" num2str(R4) "_w4_" num2str(w4) "_eps_" num2str(eps_subs) "_tand_" num2str(tand)];
