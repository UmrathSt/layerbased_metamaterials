...
data = np.loadtxt("slab_0.4_2.25.txt", delimiter=",") # 0.4 mm FR4 file with increasing mesing
#data = np.loadtxt("slab_4_2.25.txt", delimiter=",") # 4 mm FR4 file 


f = data[:,0] # in GHz
D = 76.8541*1e-3 # 0.4 mm fr4 thickness
#D = (77.7256-4.5)*1e-3 # 4 mm fr4 thickness
